...
'name': '',
'closed': '',
'custom': 'Whether custom protection model is to be used ?',
'type': '',
'subtype': '',
'prot_curve_type': '',
'prot_0_curve_type': '',
...
'closed': '',
'custom': 'Whether custom protection model is to be used ?',
'trip_unit':  'Whether overload relay is provided/ enabled ?',
'prot_curve_type': 'Trip curve used for overload protection',
'Isc': 'Rated short circuit breaking capacity of contactor',
},
'element_co_switch': {
'ref': '',
'name': '',
...
'working_temp_degree': 'Line working temperature',
...
'conductor_material': '',
'insulation_material': '',
'r_ohm_per_km': 'AC resistance of the cable at 90 degC (IS-8130)',
'x_ohm_per_km': 'Reactance of the cable at 50 Hz',
'c_nf_per_km': 'Capacitance of the cable',
'g_us_per_km': 'Dielectric conductance of the cable',
'r0n_ohm_per_km': 'Zero sequence resistance of the cable for neutral (approx. 3x R)',
'x0n_ohm_per_km': 'Zero sequence reactance of the cable for neutral (approx. 3x X)',
'c0n_nf_per_km': 'Zero sequence capacitance of the cable for neutral',
'r0g_ohm_per_km': 'Zero sequence resistance of the cable for protective earth return (approx. 3x R)',
'x0g_ohm_per_km': 'Zero sequence reactance of the cable for protective earth return (approx. 3x X)',
'c0g_nf_per_km': 'Zero sequence capacitance of the cable for protective earth return',
'working_temp_degree': 'Cable working temperature',
'endtemp_degree': 'Short-Circuit end temperature of the cable',
'max_i_ka': 'Current carrying capacity of the cable in the selected installation method',
'phase_sc_current_rating': 'Short-Circuit current rating of phase conductor (1s)',
'cpe_sc_current_rating': 'Short-Circuit current rating of phase ciruit protective earthing conductor (1s)',
'df': 'Derating factor',
'designation': '',
