...
"""
    ...
    def __init__(self, cordinates=(0,0), **kwargs):
        ...
        cross_sections_cu = [1.5, 2.5, 4, 6, 10, 16, 25, 35, 50, 70, 95, 120, 150, 185, 240, 300, 400, 500, 630, 800, 1000]
        cross_sections_al = [2.5, 4, 6, 10, 16, 25, 35, 50, 70, 95, 120, 150, 185, 240, 300, 400, 500, 630, 800, 1000]
        ...
        # Laying type n
        #
        self.current_rating_table_al_1ph = [[ [[0,1000,8.61,0.616]], [[0,1000,11.6,0.615]] ],
                                            [ [[0,120,8.361,0.6025],[120,1000,7.84,0.616]], [[0,120,11.26,0.602],[120,1000,10.56,0.615]] ],
                                            [ [[0,1000,10.51,0.6254]], [[0,1000,13.95,0.627]] ],
                                            [ [[0,1000,10.24,0.5994]], [[0,1000,13.5,0.603]] ],
                                            [ [[0,16,11.6,0.625],[16,1000,10.55,0.640]], [[0,16,14.8,0.625],[16,1000,12.6,0.648]] ],
                                            [ [[0,1000,13.6,0.540]], [[0,1000,15.82,0.541]] ],
                                            [ [[0,1000,1.1*13.6,0.540]], [[0,1000,1.1*15.82,0.541]] ],
                                            [ [[0,16,12.8,0.627],[16,1000,11.4,0.64]], [[0,16,16.0,0.625],[16,1000,13.4,0.649]] ],
                                           ]
        self.current_rating_table_al_3ph = [[ [[0,1000,7.94,0.612]], [[0,1000,10.9,0.605]] ],
                                            [ [[0,120,7.712,0.5984],[120,1000,7.225,0.612]], [[0,120,10.58,0.592],[120,1000,9.92,0.605]] ],
                                            [ [[0,1000,9.265,0.627]], [[0,1000,12.3,0.630]] ],
                                            [ [[0,1000,9.03,0.601]], [[0,1000,11.95,0.605]] ],
                                            [ [[0,16,10.5,0.625],[16,1000,9.536,0.6324]], [[0,16,13.5,0.625],[16,1000,11.5,0.639]] ],
                                            [ [[0,1000,11.2,0.542]], [[0,1000,13.2,0.539]] ],
                                            [ [[0,1000,1.1*11.2,0.542]], [[0,1000,1.1*13.2,0.539]] ],
                                            [ [[0,16,11.0,0.62],[16,1000,9.9,0.64]], [[0,16,13.7,0.623],[16,1000,12.6,0.635]] ],
                                           ]
        self.current_rating_table_cu_1ph = [[ [[0,1000,11.2,0.6118]], [[0,1000,14.9,0.611]] ],
                                            [ [[0,120,10.8,0.6015],[120,1000,10.19,0.6118]], [[0,120,14.46,0.598],[120,1000,13.56,0.611]] ],
                                            [ [[0,1000,13.5,0.625]], [[0,1000,17.76,0.6250]] ],
                                            [ [[0,1000,13.1,0.600]], [[0,1000,17.25,0.600]] ],
                                            [ [[0,16,15.0,0.625],[16,1000,15.0,0.625]], [[0,16,18.77,0.628],[16,1000,17.0,0.650]] ],
                                            [ [[0,1000,17.42,0.540]], [[0,1000,20.25,0.542]] ],
                                            [ [[0,1000,1.1*17.42,0.540]], [[0,1000,1.1*20.25,0.542]] ],
                                            [ [[0,16,16.8,0.62],[16,1000,14.9,0.646]], [[0,16,20.5,0.623],[16,1000,18.6,0.646]] ],
                                           ]
        self.current_rating_table_cu_3ph = [[ [[0,1000,10.4,0.605]], [[0,1000,13.34,0.611]] ],
                                            [ [[0,120,10.1,0.592],[120,1000,9.462,0.605]], [[0,120,12.95,0.598],[120,1000,12.14,0.611]] ],
                                            [ [[0,1000,11.84,0.628]], [[0,1000,15.62,0.6252]] ],
                                            [ [[0,1000,11.65,0.6005]], [[0,1000,15.17,0.6]] ],
                                            [ [[0,16,13.5,0.625],[16,1000,12.4,0.635]], [[0,16,17,0.623],[16,1000,15.4,0.635]] ],
                                            [ [[0,1000,14.34,0.542]], [[0,1000,16.88,0.539]] ],
                                            [ [[0,1000,1.1*14.34,0.542]], [[0,1000,1.1*16.88,0.539]] ],
                                            [ [[0,16,14.3,0.62],[16,1000,12.9,0.64]], [[0,16,17.8,0.623],[16,1000,16.4,0.637]] ],
                                           ]
